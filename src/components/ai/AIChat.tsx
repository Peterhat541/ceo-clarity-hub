      ...
      {showWelcome && (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            ...
            <div className="w-full max-w-lg">
              ...
              {(() => {
                const isActive = !!(input.trim() || isRecording);
                return (
                  <div className={isActive ? "gradient-border-input" : "gradient-filled-input"}>
                    <div className="flex items-center gap-2 bg-secondary rounded-2xl px-4 py-3">
                      <input
                        ...
                        className="flex-1 bg-transparent border-none text-sm focus:outline-none disabled:opacity-50 py-2"
                      />
                      <Button
