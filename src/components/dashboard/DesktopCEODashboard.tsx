      ...
      <div className="flex-1 flex min-h-0">
        ...
        <aside className="w-[260px] shrink-0 border-r border-border/50 bg-sidebar-background flex flex-col">
          ...
          <div className="p-4 border-t border-border/30">
            <Button onClick={() => setSendNoteOpen(true)} variant="ghost" className="w-full h-10 !bg-secondary/60 hover:!bg-secondary active:!bg-secondary focus-visible:!bg-secondary text-foreground hover:text-foreground active:text-foreground font-medium gap-2 text-sm">
