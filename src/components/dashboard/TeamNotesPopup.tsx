import { X, MessageSquare, User, Building2, Check, Eye, Clock } from "lucide-react";
...
function NoteItem({ note, onStatusChange }: { note: TeamNote; onStatusChange: (status: NoteStatus) => void }) {
